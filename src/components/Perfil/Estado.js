        ...
        <div className="row mx-0">
            ...
            <div className="col-10 px-0">
                <div className="progress estado">
                    <div className={'progress-bar vida-progress ' + color} role="progressbar" style={{ width: `${ (estadoActual/estadoMaximo)*100 }%` }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                    </div>
                </div>
